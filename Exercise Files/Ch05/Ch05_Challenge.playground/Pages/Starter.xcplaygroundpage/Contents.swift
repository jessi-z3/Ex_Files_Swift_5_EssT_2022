...
var hulkSmash : Attack = ("Hulk Smash", 100)
// 2
...
// 4
attackEnemy(damage: 8)
var message = attackEnemy(attack:hulkSmash)
print(message)
// 5
typealias AttackClosure = ([Attack]) -> Void
let playerActions = [("Lawyer Up", 5),("Objection", 15),("Cross Examine", 40)]
// 6
