 ...
 */
// 1
var lefthandWeapon: String? = "katana"
var righthandWeapon: String? = "blaster"

// 2
if let leftWeapon = lefthandWeapon, let rightWeapon = righthandWeapon{
    print("My weapons are \(leftWeapon) and \(rightWeapon).")
} else {
    print("I didn't bring enough hardware for this.")
}

// 3
var playerExp : [String : Int]  = ["John" : 0,"Paul" : 300,"Mark" : 489]
// 4 and 5
